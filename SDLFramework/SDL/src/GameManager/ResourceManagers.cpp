...
void ResourceManagers::set_Play1Win(bool on)
{	
	Play1Win = on;
};
bool ResourceManagers::get_Play1Win()
{
	return Play1Win;
};
void ResourceManagers::set_Play2Win(bool on)
{
	Play2Win = on;
};
bool ResourceManagers::get_Play2Win()
{
	return Play2Win;
};
...
void ResourceManagers::set_Music(bool on)
{
	on_Music = on;
};
bool ResourceManagers::get_Music()
{
	return on_Music;
};
