...
void GSEnd3::HandleEvents()
{
}

void GSEnd3::HandleKeyEvents(SDL_Event& e)
{

}

void GSEnd3::HandleTouchEvents(SDL_Event& e)
{
...
void GSEnd3::HandleMouseMoveEvents(int x, int y)
{
}

void GSEnd3::Update(float deltaTime)
{
...
void GSEnd3::Draw(SDL_Renderer* renderer)
{
