...
void GSEnd2::HandleEvents()
{
}

void GSEnd2::HandleKeyEvents(SDL_Event& e)
{

}

void GSEnd2::HandleTouchEvents(SDL_Event& e)
{
...
void GSEnd2::HandleMouseMoveEvents(int x, int y)
{
}

void GSEnd2::Update(float deltaTime)
{
...
void GSEnd2::Draw(SDL_Renderer* renderer)
{
